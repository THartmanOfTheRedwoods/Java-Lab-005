...
The first if condition checks flag1 && flag2, which is true && true, so "ping!" is printed.

The second if condition checks flag1 || flag2, which is true || true, so "pong!" is printed.

The output of flowofexecution will be : 
