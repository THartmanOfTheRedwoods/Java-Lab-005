...
the boolean flag1 is set to the return value of isHoopy with x = 202, since 202 is divisible by 2 it returns true. <br>
the boolean flag2 is set to the return value of isFrabjuous with x = 202, since 202 is > 0 it returns true. <br>
the code then prints the values of flag1 and flag2 thus giving you the two trues. <br>
then it sees if both flag1 and flag2 are true and if they are it prints ping! and since they are both true it does. <br>
then it sees if either flag1 or flag2 is true and if one of them is it prints pong! since at least one of them is true it does.
